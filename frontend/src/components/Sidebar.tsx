            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={`bg-surface-raised border-border-muted text-zinc-200 focus-visible:ring-zinc-600 pl-9 text-base sm:text-sm text-right cursor-pointer ${HIDE_TIME_PICKER_INDICATOR}`}
                />
              </div>
              {startTime && (
                <button
